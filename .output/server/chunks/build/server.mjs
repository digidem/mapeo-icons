import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, getCurrentInstance, hasInjectionContext, inject, shallowRef, provide, cloneVNode, h, createElementBlock, computed, unref, shallowReactive, ref, Suspense, Fragment, createApp, createVNode, Text, toRef, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, reactive, effectScope, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, mergeProps, getCurrentScope, withCtx, nextTick, useSSRContext } from 'vue';
import { c as createError$1, s as hasProtocol, t as isScriptProtocol, v as joinURL, w as withQuery, x as sanitizeStatusCode, y as getContext, z as parsePath, A as parseQuery, $ as $fetch$1, B as createHooks, C as executeAsync, D as toRouteMatcher, E as createRouter$1, F as defu, G as getRequestURL, H as getCookie, I as getRequestHeader, p as destr, J as klona, K as createDefu, L as isEqual, M as withoutTrailingSlash, N as setCookie, O as deleteCookie, P as isEqual$1 } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "index___en",
    path: "/",
    component: () => import('./index-Bkepk5Et.mjs')
  },
  {
    name: "index___pt",
    path: "/pt",
  ...
  },
  {
    name: "images___en",
    path: "/images",
    component: () => import('./images-BdPFJ7cc.mjs')
  },
  {
    name: "images___pt",
    path: "/pt/images",
  ...
  },
  {
    name: "result___en",
    path: "/result",
    component: () => import('./result-DluoMavu.mjs')
  },
  {
    name: "result___pt",
    path: "/pt/result",
  ...
  en: [
    {
      ...
      load: () => import(
        './en-DXnTuoaJ.mjs'
        /* webpackChunkName: "locale_en_46json_8175566f" */
      ),
      cache: true
    }
  ],
  pt: [
    {
      ...
      load: () => import(
        './pt-zTox7CBj.mjs'
        /* webpackChunkName: "locale_pt_46json_2f30148f" */
      ),
      cache: true
    }
  ],
  es: [
    {
      ...
      load: () => import(
        './es-BZcx07tO.mjs'
        /* webpackChunkName: "locale_es_46json_44e7aa56" */
      ),
      cache: true
    }
  ],
  th: [
    {
      ...
      load: () => import(
        './th-Dr9Gn1NL.mjs'
        /* webpackChunkName: "locale_th_46json_74e2e62b" */
      ),
      cache: true
    }
  ]
...
function createNuxtI18nContext(nuxt, vueI18n, defaultLocale) {
  ...
  const loadMessagesFromServer = async (locale) => {
    ...
    const messages = await $fetch(`/_i18n/${"vOAJHJNk"}/${locale}/messages.json`, { headers });
...
const i18n_EI7LsD1KYQADczz5hrChviGQCdVM8yUkvFEZLJpmnvM = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(_nuxt) {
    let __temp, __restore;
    Object.defineProperty(_nuxt.versions, "nuxtI18n", { get: () => "10.1.2" });
    const nuxt = useNuxtApp(_nuxt._id);
    const runtimeI18n = useRuntimeI18n(nuxt);
    ...
    prerenderRoutes(localeCodes.map((locale) => `/_i18n/${"vOAJHJNk"}/${locale}/messages.json`));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CJmI5XtM.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BXV01ynV.mjs'));
...
export { _export_sfc as _, useI18n as a, useRouter as b, useLocalePath as c, useRoute as d, entry$1 as default, __nuxt_component_1 as e, useNuxtApp as f, asyncDataDefaults as g, createError as h, fetchDefaults as i, useRequestFetch as j, useRuntimeConfig as k, nuxtLinkDefaults as l, navigateTo as n, resolveRouteObject as r, useHead as u };
